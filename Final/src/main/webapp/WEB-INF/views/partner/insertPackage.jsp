			...
			<div class="col-lg-8 col-md-8">
				...
				<form action="/packageInsert.do" method="post">
					<div class="step">
						...
						onblur="this.placeholder = '텍스트창에서 미입력 후 다른창으로 옮길때 띄울메세지'" required(미입력시 버튼누르면 입력해달라고 뜨게하는거) -->
								<h6>추가상품</h6>
								<input type="text" name="product_name" placeholder="상품명" onfocus="this.placeholder = ''" onblur="this.placeholder = '상품명'" required class="single-input" style="width: 90%; display: inline-block;" required> <br>
								<br>
						...
						<div>
							<label class="genric-btn primary-border"
								...
								파일선택 <input type="file" id="formFile" name="mainPicture"
					...
					<div class="step">
						<h4>이용안내</h4>
						<div class="mt-10">
							<textarea class="single-textarea" style="height: 150px"
						...
						<h4>안내사항</h4>
						<div class="mt-10">
							<textarea class="single-textarea" style="height: 160px"
					...
					<div class="step">
						...
						<h4>연락처</h4>
						<div class="input-group-icon mt-10">
							<input type="text" name="address" placeholder="ex) 010-0000-0000"
								class="single-input">
						</div>
						<hr>
						<h4>홈페이지 주소</h4>
